<template>
    <div>
        ...
        <main>
            ...
            <NuxtLink to="/User/SignUp" class="btn pink">Sign Up</NuxtLink>
            ...
            <div class="signin-form">
                ...
                <NuxtLink to="/User/Reset">Do you want to reset your password?</NuxtLink>
            </div>

            <button class="btn outline">Sign In with Google</button>
        </main>
